<div class="modal fade" id="modalDeleteProduct{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form id="form-delete" action="{{route('products.destroy',$row)}}" method="post">
            @csrf @method('delete')
